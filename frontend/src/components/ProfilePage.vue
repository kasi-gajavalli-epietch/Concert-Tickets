            ...
            <div class="navbar-start">
              ...
              <span class="navbar-item">
                <a
                  ...
                  href="http://localhost:8080/#concert_list"
                >
                  <span class="icon">
                    <i class="fa fa-music" />
                  </span>
              ...
              <span class="navbar-item">
                <a
                  class="button is-dark is-outlined"
                  href="http://localhost:8080/#group_list"
                >
                  <span class="icon">
  ...
  data() {
    return {
      ...
      user_id: JSON.parse(localStorage.getItem("auth"))
        ...
        : null,
      avatar: JSON.parse(localStorage.getItem("auth"))
        ? JSON.parse(localStorage.getItem("auth")).user.avatar_url
        : "https://www.blexar.com/avatar.png",
      firstname: JSON.parse(localStorage.getItem("auth"))
        ? JSON.parse(localStorage.getItem("auth")).user.firstname
        : null,
      lastname: JSON.parse(localStorage.getItem("auth"))
        ? JSON.parse(localStorage.getItem("auth")).user.lastname
        : null,
      address: JSON.parse(localStorage.getItem("auth"))
